...
embed.set_author(name="Info", url="https://example.com")

embed.add_field(name="Field Name", value="This is the field value.", inline=False)
embed.add_field(name="The first inline field.", value="This field is inline.", inline=True)
embed.add_field(
